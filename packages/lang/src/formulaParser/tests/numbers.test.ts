...
describe('valid numbers', () => {
  cases<[string, Values.Value] | [string, Values.Value, string]>(
    c(['0', Values.int(0)]),
    c(['0x10', Values.int(0x10, 'hexadecimal'), '0x00000010']),
    c(['0xdeadbeef', Values.int(0xdeadbeef, 'hexadecimal'), '0xdeadbeef']),
    c(['0xc_deadbeef', Values.int(55275536111, 'hexadecimal'), '0x0000000c_deadbeef']),
    c(['0b10', Values.int(0b10, 'binary'), '0b00000010']),
    c(['0o10', Values.int(0o10, 'octal'), '0o00000010']),
