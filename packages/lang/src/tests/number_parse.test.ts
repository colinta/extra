...
describe('number parse', () => {
      ...
      c([
        ...
        Types.namedFormula(
          ...
          [
            ...
            Types.namedArgument({
              name: 'radix',
              type: Types.oneOf([Types.IntType.narrow(2, undefined), Types.enumShorthand('auto')]),
              isRequired: false,
            }),
          ],
  ...
  describe('eval', () => {
    cases<[string, Values.Value]>(
      ...
      c(['Int.parse("0x10", radix: .auto)', Values.int(16)]),
      c(['Int.parse("-0x10", radix: .auto)', Values.int(-16)]),
      c(['Int.parse("0b10", radix: .auto)', Values.int(2)]),
      c(['Int.parse("-0b10", radix: .auto)', Values.int(-2)]),
      c(['Int.parse("0o10", radix: .auto)', Values.int(8)]),
      c(['Int.parse("-0o10", radix: .auto)', Values.int(-8)]),
      c(['Int.parse("10", radix: .auto)', Values.int(10)]),
      c(['Int.parse("0xZ", radix: .auto)', Values.nullValue()]),
      c(['Int.parse("0b2", radix: .auto)', Values.nullValue()]),
      c(['Int.parse("0o9", radix: .auto)', Values.nullValue()]),
